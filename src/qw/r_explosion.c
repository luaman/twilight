...
#define EXPLOSIONFADESTART (0.4f)
#define EXPLOSIONFADERATE (1.0f)
...
{
	int i, index;
	int alpha = bound(0, e->alpha * 128.0f, 128);
	int *indexlist = &explosiontris[0][0];
	float s, t;
//	s = cl.time * 1;
//	t = cl.time * 0.75;
//	s -= (int) s;
...
//	glDisableClientState(GL_TEXTURE_COORD_ARRAY);
	...
	*/
	...
	{
		transpolybegin(explosiontexture, explosiontexturefog, TPOLYTYPE_ALPHA);
