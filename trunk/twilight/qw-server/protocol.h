...
#define	svc_print			8			// [byte] id [string] null terminated
										// string
#define	svc_stufftext		9			// [string] stuffed into client's
										// console buffer
								// the string should be \n terminated
#define	svc_setangle		10			// [angle3] set the view angle to this
										// absolute value
...
#define	svc_centerprint		26			// [string] to put in center of the
										// screen

#define	svc_killedmonster	27
#define	svc_foundsecret		28

#define	svc_spawnstaticsound	29		// [coord3] [byte] samp [byte] vol
										// [byte] aten
...
#define	svc_nails			43			// [byte] num [48 bits] xyzpy 12 12 12
										// 4 8
...
#define	clc_delta		5				// [byte] sequence number, requests
										// delta compression of message
...
#define	U_SOLID		(1<<6)				// the entity should be solid for
										// prediction
...
#define	UPDATE_BACKUP	64				// copies of entity_state_t to keep
										// buffered
