...
//      Draw_String ( x , y, "---- -- ---- ----- ----------------");
	...
	for (i = 0; i < l && y <= vid.height_2d - 10; i++) {
		...
		if (p > 25)
			Draw_Alt_String (x + 32, y, num, 8);
		else
			Draw_String (x + 32, y, num, 8);
		...
		Draw_String_Len (x + 112, y, num, 3, 8);
