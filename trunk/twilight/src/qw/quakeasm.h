...
C (xcenter)
.extern
C (d_vrectbottom_particle)
.extern
C (d_vrectright_particle)
.extern
C (d_vrecty)
.extern
C (d_vrectx)
...
C (r_zistepy)
.extern
C (D_PolysetSetEdgeTable)
.extern
C (D_RasterizeAliasPolySmooth)
