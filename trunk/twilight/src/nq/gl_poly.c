...
transpolyrender (void)
{
	...
	qglTexCoordPointer (2, GL_FLOAT, sizeof(tc_array_v(0)), tc_array_v(0));
	qglColorPointer (4, GL_FLOAT, sizeof(c_array_v(0)), c_array_v(0));
	qglVertexPointer (3, GL_FLOAT, sizeof(v_array_v(0)), v_array_v(0));
}
