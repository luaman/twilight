...
PF_sin (void)
{
	G_FLOAT (OFS_RETURN) = Q_sin (G_FLOAT (OFS_PARM0));
}

void
PF_cos (void)
{
	G_FLOAT (OFS_RETURN) = Q_cos (G_FLOAT (OFS_PARM0));
}

void
PF_sqrt (void)
{
	G_FLOAT (OFS_RETURN) = Q_sqrt (G_FLOAT (OFS_PARM0));
}
#endif
